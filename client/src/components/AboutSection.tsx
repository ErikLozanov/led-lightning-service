          ...
          <div data-aos="fade-right">
            <div>
              ...
              <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
                <p>
                  В <strong className="text-white">VPrime Lights</strong> не просто полираме фарове – ние възстановяваме сигурността. Разбираме, че кристално ясните светлини не са само естетика, а жизненоважен елемент за вашето безопасно шофиране през нощта.
                </p>
                <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24">
            {[
              ...
              { icon: Award, num: "100%", text: "Гаранция за Качество" }
               ...
               <div key={i} data-aos="zoom-in" data-aos-delay={i * 200} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-xl hover:border-[#00f3ff]/50 transition-colors group text-center">
