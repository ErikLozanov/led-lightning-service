...
const ContactSection = () => {
  return (
    <footer id="contact" className="bg-black border-t border-slate-800 pt-20 pb-10 relative overflow-hidden">
            ...
            <li>
              <a href="viber://chat?number=%2B359888888888" className="flex items-center gap-3 text-gray-300 hover:text-neon-blue transition-colors group">
                <span className="bg-slate-800 p-2 rounded group-hover:bg-purple-500 group-hover:text-white transition-colors">
                   <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.497 1.745 6.616 4.472 8.652v4.237l4.086-2.242c1.09.301 2.246.464 3.442.464 6.627 0 12-4.975 12-11.111C24 4.974 18.627 0 12 0zm0 2.05c5.334 0 9.778 3.978 9.778 8.93 0 5.084-4.444 9.061-9.778 9.061-1.075 0-2.105-.164-3.07-.466l-2.03.116L5.807 20.3l.05-2.257c-2.115-1.638-3.525-4.148-3.525-6.932 0-4.952 4.314-8.93 9.668-8.93z"/></svg>
                </span>
                Чат във Viber
              </a>
            </li>
