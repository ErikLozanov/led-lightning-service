...
const ProjectCard = ({ project }: ProjectCardProps) => {
  return (
    <div className="bg-slate-900 rounded-2xl overflow-hidden border border-slate-800 hover:border-neon-blue/50 transition-all duration-300 shadow-2xl hover:shadow-[0_0_30px_rgba(0,243,255,0.1)] group h-full flex flex-col">
      ...
      <div className="p-6 relative flex-1 flex flex-col">
        <Link to={`/project/${project.slug}`}>
          <h3 className="text-xl font-bold text-white mb-3 hover:text-neon-blue transition-colors uppercase truncate">
            {project.car_model}
          </h3>
        </Link>
        <p className="text-gray-400 text-sm leading-relaxed line-clamp-2 border-l-2 border-neon-blue/30 pl-3 mb-4">
          {project.description}
        </p>
